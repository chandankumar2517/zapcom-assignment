...
class BannerItemAdapter(private val items: List<Item>) : RecyclerView.Adapter<BannerItemAdapter.HorizontalItemViewHolder>() {
    ...
    class HorizontalItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val textView: TextView = itemView.findViewById(R.id.bannerName)
